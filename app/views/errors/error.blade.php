  ...
  <body>
    ...
    <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel-heading">
              <h4 class="panel-title">Whoops, an error has occurred!</h4>
            </div>
            <div class="panel-body">
              <p>Something might be broken or you are trying to break the system.</p>
            </div>
            <div class="panel-footer">
              <a href="https://aaulan.dk" class="btn btn-default">Go to frontpage</a>
            </div>
          </div>
