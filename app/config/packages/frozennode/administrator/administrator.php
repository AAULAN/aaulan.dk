...
return array(
	 ...
	 *	)
	 */
	'menu' => array('users','lan_users','Teams'=>array('teams','team_user'),'Pizza'=>array('pizzas','pizzatoppings','pizzaorder_rounds','pizzaorders','pizzaorder_pizza'),'entries','pages','schedule','slides','tournaments','winners','crew','sponsor','ACL'=>array('permissions','roles')),
